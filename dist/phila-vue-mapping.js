(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet'), require('esri-leaflet'), require('axios'), require('L-esri-WebMap'), require('lodash.debounce'), require('leaflet-vector-icon'), require('leaflet-measure'), require('jquery'), require('proj4'), require('blueimp-md5'), require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/pro-regular-svg-icons'), require('@fortawesome/pro-solid-svg-icons'), require('@fortawesome/vue-fontawesome')) :
  typeof define === 'function' && define.amd ? define(['exports', 'leaflet', 'esri-leaflet', 'axios', 'L-esri-WebMap', 'lodash.debounce', 'leaflet-vector-icon', 'leaflet-measure', 'jquery', 'proj4', 'blueimp-md5', '@fortawesome/fontawesome-svg-core', '@fortawesome/pro-regular-svg-icons', '@fortawesome/pro-solid-svg-icons', '@fortawesome/vue-fontawesome'], factory) :
  (factory((global.philaVueMapping = {}),global.L,global.L.esri,global.axios,global.LEsriWebMap,global.debounce,global.leafletVectorIcon,global.L.Control.Measure,global.$,global.proj4,global.md5,global.fontawesomeSvgCore,global.proRegularSvgIcons,global.proSolidSvgIcons,global.vueFontAwesome));
}(this, (function (exports,L$1,esriLeaflet,axios,LEsriWebMap,debounce,VectorIcon,MeasureControl,$$1,proj4,md5,fontawesomeSvgCore,proRegularSvgIcons,proSolidSvgIcons,vueFontawesome) { 'use strict';
  ...
  fontawesomeSvgCore.library.add(proSolidSvgIcons.faSearch, proSolidSvgIcons.faTimes, proSolidSvgIcons.faMapMarkerAlt, proRegularSvgIcons.faDotCircle, proSolidSvgIcons.faCaretLeft, proSolidSvgIcons.faCaretRight);
