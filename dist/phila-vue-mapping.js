(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/vue-fontawesome'), require('esri-leaflet'), require('L-esri-WebMap'), require('leaflet-vector-icon'), require('leaflet-measure'), require('axios'), require('leaflet'), require('proj4'), require('jquery'), require('blueimp-md5')) :
	typeof define === 'function' && define.amd ? define(['exports', '@fortawesome/fontawesome-svg-core', '@fortawesome/vue-fontawesome', 'esri-leaflet', 'L-esri-WebMap', 'leaflet-vector-icon', 'leaflet-measure', 'axios', 'leaflet', 'proj4', 'jquery', 'blueimp-md5'], factory) :
	(factory((global.philaVueMapping = {}),global.fontawesomeSvgCore,global.vueFontAwesome,global.L.esri,global.LEsriWebMap,global.leafletVectorIcon,global.L.Control.Measure,global.axios,global.L,global.proj4,global.$,global.md5));
}(this, (function (exports,fontawesomeSvgCore,vueFontawesome,esriLeaflet,LEsriWebMap,VectorIcon,MeasureControl,axios,L$1,proj4,$$1,md5) { 'use strict';
	...
	var MapAddressCandidateList = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(this.shouldShowAddressCandidateList),expression:"this.shouldShowAddressCandidateList"}],class:this.listGroupClass},[_c('ul',_vm._l((_vm.candidates),function(candidate,i){return _c('li',[_c('a',{staticClass:"list-group-item",attrs:{"href":_vm.createLink(candidate),"tabindex":"-1","id":'address-candidate-list-' + i},on:{"click":function($event){return _vm.closeAddressCandidateList(candidate)},"keydown":_vm.maybeUsedArrow}},[_vm._v(" "+_vm._s(candidate)+" ")])])}),0)])},staticRenderFns: [],_scopeId: 'data-v-01ba1c49',
