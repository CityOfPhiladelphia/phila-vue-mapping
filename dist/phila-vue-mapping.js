(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet'), require('esri-leaflet'), require('axios'), require('L-esri-WebMap'), require('sdleafletdraw'), require('lodash.debounce'), require('leaflet-vector-icon'), require('leaflet-measure'), require('jquery'), require('proj4'), require('blueimp-md5'), require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/vue-fontawesome')) :
	typeof define === 'function' && define.amd ? define(['exports', 'leaflet', 'esri-leaflet', 'axios', 'L-esri-WebMap', 'sdleafletdraw', 'lodash.debounce', 'leaflet-vector-icon', 'leaflet-measure', 'jquery', 'proj4', 'blueimp-md5', '@fortawesome/fontawesome-svg-core', '@fortawesome/vue-fontawesome'], factory) :
	(factory((global.philaVueMapping = {}),global.L,global.L.esri,global.axios,global.LEsriWebMap,null,global.debounce,global.leafletVectorIcon,global.L.Control.Measure,global.$$1,global.proj4,global.md5,global.fontawesomeSvgCore,global.vueFontawesome));
}(this, (function (exports,L$1,esriLeaflet,axios,LEsriWebMap,sdleafletdraw,debounce,VectorIcon,MeasureControl,$$1,proj4,md5,fontawesomeSvgCore,vueFontawesome) { 'use strict';
