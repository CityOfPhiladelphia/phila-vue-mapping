(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet'), require('esri-leaflet'), require('axios'), require('L-esri-WebMap'), require('lodash.debounce'), require('leaflet-vector-icon'), require('leaflet-measure'), require('jquery'), require('proj4'), require('blueimp-md5'), require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/pro-regular-svg-icons/faDotCircle'), require('@fortawesome/pro-solid-svg-icons/faSearch'), require('@fortawesome/pro-solid-svg-icons/faTimes'), require('@fortawesome/pro-solid-svg-icons/faMapMarkerAlt'), require('@fortawesome/pro-solid-svg-icons/faCaretLeft'), require('@fortawesome/pro-solid-svg-icons/faCaretRight'), require('@fortawesome/vue-fontawesome')) :
  typeof define === 'function' && define.amd ? define(['exports', 'leaflet', 'esri-leaflet', 'axios', 'L-esri-WebMap', 'lodash.debounce', 'leaflet-vector-icon', 'leaflet-measure', 'jquery', 'proj4', 'blueimp-md5', '@fortawesome/fontawesome-svg-core', '@fortawesome/pro-regular-svg-icons/faDotCircle', '@fortawesome/pro-solid-svg-icons/faSearch', '@fortawesome/pro-solid-svg-icons/faTimes', '@fortawesome/pro-solid-svg-icons/faMapMarkerAlt', '@fortawesome/pro-solid-svg-icons/faCaretLeft', '@fortawesome/pro-solid-svg-icons/faCaretRight', '@fortawesome/vue-fontawesome'], factory) :
  (factory((global.philaVueMapping = {}),global.L,global.L.esri,global.axios,global.LEsriWebMap,global.debounce,global.leafletVectorIcon,global.L.Control.Measure,global.$,global.proj4,global.md5,global.fontawesomeSvgCore,global.faDotCircle,global.faSearch,global.faTimes,global.faMapMarkerAlt,global.faCaretLeft,global.faCaretRight,global.vueFontAwesome));
}(this, (function (exports,L$1,esriLeaflet,axios,LEsriWebMap,debounce,VectorIcon,MeasureControl,$$1,proj4,md5,fontawesomeSvgCore,faDotCircle,faSearch,faTimes,faMapMarkerAlt,faCaretLeft,faCaretRight,vueFontawesome) { 'use strict';
  ...
  var LegendBox = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"legend",domProps:{"innerHTML":_vm._s(this.legendHtml)}})])},staticRenderFns: [],
    ...
    methods: {
      initialize() {
        ...
        const legend = L$1__default.esri.legendControl(this.$props.layer, opts);
      },
      createLegend(scale) {
        ...
        const legendHtml = L$1__default.Util.template(this.options.listTemplate, {
          layers: layersHtml
        });
  ...
  fontawesomeSvgCore.library.add(faSearch.faSearch, faTimes.faTimes, faMapMarkerAlt.faMapMarkerAlt, faDotCircle.faDotCircle, faCaretLeft.faCaretLeft, faCaretRight.faCaretRight);
