(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet'), require('esri-leaflet'), require('axios'), require('L-esri-WebMap'), require('sdleafletdraw'), require('lodash.debounce'), require('leaflet-vector-icon'), require('leaflet-measure'), require('jquery'), require('proj4'), require('blueimp-md5')) :
  typeof define === 'function' && define.amd ? define(['exports', 'leaflet', 'esri-leaflet', 'axios', 'L-esri-WebMap', 'sdleafletdraw', 'lodash.debounce', 'leaflet-vector-icon', 'leaflet-measure', 'jquery', 'proj4', 'blueimp-md5'], factory) :
  (factory((global.philaVueMapping = {}),global.L,global.L.esri,global.axios,global.LEsriWebMap,null,global.debounce,global.leafletVectorIcon,global.L.Control.Measure,global.$$1,global.proj4,global.md5));
}(this, (function (exports,L$1,esriLeaflet,axios,LEsriWebMap,sdleafletdraw,debounce,VectorIcon,MeasureControl,$$1,proj4,md5) { 'use strict';
  ...
  var AddressCandidateList = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(this.shouldShowAddressCandidateList),expression:"this.shouldShowAddressCandidateList"}],class:this.listGroupClass},[_c('ul',_vm._l((_vm.candidates),function(candidate,i){return _c('li',[_c('a',{staticClass:"list-group-item",attrs:{"href":_vm.createLink(candidate),"tabindex":"-1","id":'address-candidate-list-' + i},on:{"click":function($event){_vm.closeAddressCandidateList(candidate);},"keydown":_vm.maybeUsedArrow}},[_vm._v(" "+_vm._s(candidate)+" ")])])}),0)])},staticRenderFns: [],_scopeId: 'data-v-557d70bd',
    props: ['position'],
    computed: {
      map: function map() {
        return this.$store.state.map.map;
