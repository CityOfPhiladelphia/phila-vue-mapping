(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('esri-leaflet'), require('L-esri-WebMap'), require('leaflet-vector-icon'), require('leaflet-measure'), require('axios'), require('leaflet'), require('proj4'), require('jquery'), require('blueimp-md5')) :
  typeof define === 'function' && define.amd ? define(['exports', 'esri-leaflet', 'L-esri-WebMap', 'leaflet-vector-icon', 'leaflet-measure', 'axios', 'leaflet', 'proj4', 'jquery', 'blueimp-md5'], factory) :
  (factory((global.philaVueMapping = {}),global.L.esri,global.LEsriWebMap,global.leafletVectorIcon,global.L.Control.Measure,global.axios,global.L,global.proj4,global.$,global.md5));
}(this, (function (exports,esriLeaflet,LEsriWebMap,VectorIcon,MeasureControl,axios,L$1,proj4,$$1,md5) { 'use strict';
