...
export default {
  ...
  watch: {
    buttonClass(nextButtonClass) {
      ...
      // console.log('watch ButtonClass, this.buttonId:', this.buttonId, 'buttonItem:', buttonItem, 'nextButtonClass:', nextButtonClass);
    ...
    imageLink(nextImageLink) {
      ...
      // console.log('watch imageLink, this.buttonId:', this.buttonId, 'imageItem:', imageItem, 'nextImageLink:', nextImageLink);
  ...
  mounted() {
    ...
    buttonItem.onclick = (function(event) {
      // console.log('onclick event:', event, 'event.target.id:', event.target.id);
      this.buttonClicked();
    }).bind(this);
  ...
  methods: {
    buttonClicked() {
      console.log('CycloButtonControl buttonClicked is running');
      this.$emit('click');
    },
  },
};
